...
CREATE VIEW "public"."transaction_details" AS (select "dim_account"."user_id", "dim_account"."account_key", "dim_security"."underlying_symbol", "dim_security"."option_type", "dim_security"."strike_price", JSON_AGG(
        JSON_BUILD_OBJECT(
