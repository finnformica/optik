...
import { users, dimAccount, rawTransactions, dimDate, factTransactions, dimSecurity, dimTransactionType, dimBroker, dimBrokerAccounts, userAccessTokens } from "./schema";
...
export const dimTransactionTypeRelations = relations(dimTransactionType, ({many}) => ({
	factTransactions: many(factTransactions),
}));
